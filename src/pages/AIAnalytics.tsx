...
import { BarChart2, Zap, AlertTriangle, TrendingUp, Download, FileText } from 'lucide-react';
...
const AIAnalytics = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    toast.info("Generating comprehensive farm analytics report...");
    
    // Simulate report generation
    setTimeout(() => {
      setIsGeneratingReport(false);
      toast.success("Farm Analytics Report generated successfully!");
      
      // Generate and download a sample report
      const reportData = {
        farmName: "Smart Farm Analytics",
        date: new Date().toLocaleDateString(),
        yieldAnalysis: yieldData,
        resourceAllocation: resourceData,
        insights: insights,
        recommendations: [
          "Review irrigation scheduling for all fields to optimize water usage",
          "Implement pest control measures in the north fields within 3 days", 
          "Adjust nitrogen application rates according to recommendation"
        ]
      };
...
=== CROP YIELD ANALYSIS ===
${yieldData.map(crop => `${crop.name}: ${crop.current} (vs ${crop.previous} previous year)`).join('\n')}

=== RESOURCE ALLOCATION ===
${resourceData.map(resource => `${resource.name}: ${resource.value}%`).join('\n')}
...
Generated by Smart Farm Analytics Platform
      `;
      ...
      a.href = url;
      a.download = `farm-analytics-report-${new Date().toISOString().split('T')[0]}.txt`;
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center pt-4">
                    <Button 
                      className="bg-farm-orange hover:bg-opacity-90 mr-4"
