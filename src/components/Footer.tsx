...
const Footer = () => {
  return (
    <footer className="bg-farm-darkgreen text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-farm-orange transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Stay updated with the latest agricultural insights and FarmFuture news.
            </p>
            <form className="flex flex-col space-y-2">
              <input
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 rounded-md bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-farm-orange"
              />
        ...
        <div className="border-t border-white/10 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} FarmFuture. All rights reserved.
            </p>
